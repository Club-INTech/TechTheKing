...
public:
	...
	*/
	void begin(int dataPin, int clockPin, bool kybdLites);
	...
	*/
	...
	/**
	* Gestion du clavier pour lire une touche, ici dit si le code bar est un roi
	* @return Le code de la touche
	* @param *uint8_t pointeur vers l'endroit de stockage de la touche
	*/
	int8_t lectureTouche( uint8_t *touche );
	/**
	* Attente de confirmation d'une touche
	* @param uint8_t le code de la touche
	* @return retournee 1 si confirmation, 0 sinon
	*/
	uint8_t confirmation( uint8_t touche );
