 ...
 */
void 
Asservissement::changeKp(uint16_t kpDonne)
{
	kp = kpDonne;
}

void 
Asservissement::changePWM(int16_t maxPwmDonne)
{
	maxPWM = maxPwmDonne;
}

void
Asservissement::changeVmax(int32_t vMaxDonne)
{
	vMax = vMaxDonne;
}

void
Asservissement::changeKd(uint16_t kdDonne)
{
	kd = kdDonne;
}
...
void
Asservissement::changeKi(uint16_t kiDonne)
{
	ki = kiDonne;
}

void
Asservissement::changeKpVitesse(uint16_t kpVitesseDonne)
{
	kpVitesse=kpVitesseDonne;
}

void
Asservissement::setVitesse(int32_t vitesseDonnee)
{
